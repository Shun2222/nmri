...
print(jcope_n[dtidx].shape)
jcope_n = kurosio_filter_pooled(jcope_n[dtidx], nan_map_pooled) # 時刻0のjcope data
print(jcope_n.shape)
jn_map = kurosio_vec_to_map_pooled(jcope_n, nan_map_pooled) * nan_map_pooled
print(jn_map.shape)
# jn_map = jcope_n[dtidx]
df_jn_map = pd.DataFrame(jn_map)

path = osp.join(r'./data', f'jcope_n{year}{month:02}{day:02}{hour:02}.csv')
