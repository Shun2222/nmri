...
deg_per_mesh = 1/6
nan_map_path = r'nan_map_pooled6.csv'
...
class KurosioRangePluse():
    ...
    def is_in_kurosio_test(self, lat, lon):
        ...
        return True
class Settei:
    # LatIdxMax = 1800#900 # 1800
    # LatIdxMin = 750#375 # 750
    # LonIdxMax = 5401#2701 # 5401
    # LonIdxMin = 4211#2105 # 4211
    LatIdxMax = 300 #600 # 900 # 1800
    LatIdxMin = 126 #251 # 376 # 750
    LonIdxMax = 899 #1800 # 2700 # 5401
    LonIdxMin = 702 #1404 # 2106 # 4211
...
if __name__ == "__main__":
    ...
    if True:
        ...
        year = 2015
        month = 9
        out_folder = r'E:/shunsukeE/data/ais/1509-ais4s-pkls-pooled6-entire'
        ...
        # day = 1
        # data = al.load_ais_day(day, use_pkl=False)# AIS4ToCur classでcsvファイルで保存されたファイルのうちset_keysで設定したファイルを読み込み、辞書型で返す（例：data['cur1'] = 固有値方向の偏流１のデータ）
