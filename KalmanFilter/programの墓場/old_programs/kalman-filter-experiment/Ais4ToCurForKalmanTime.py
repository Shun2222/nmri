...
deg_per_mesh = 1/12
nan_map_path = r'nan_map_pooled3.csv'
...
class Settei:
    ...
    LatIdxMax = 600 # 900 # 1800
    LatIdxMin = 251 # 376 # 750
    LonIdxMax = 1800 # 2700 # 5401
    LonIdxMin = 1404 # 2106 # 4211
...
if __name__ == "__main__":
    ...
    if True:
        ...
        year = 2015
        month = 9
        out_folder = r'E:/shunsukeE/data/ais/1509-ais4s-pkls-pooled3'
